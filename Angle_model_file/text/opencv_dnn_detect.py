...
import numpy as np
import cv2
from Angle_model_file.component.image import letterbox_image
from Angle_model_file.config import config

AngleModelFlag = config.AngleModelFlag
AngleModelPb = config.AngleModelPb
AngleModelPbtxt = config.AngleModelPbtxt
